...
final class ToneGeneratorTests: XCTestCase {
    ...
    func testRapidToneRequestsAreAllProcessed() async {
        ...
        XCTAssertGreaterThan(elapsed, minimumExpectedTime,
    ...
    func testTonesPlaySequentiallyNotConcurrently() async {
        ...
        async let tone1: Void = toneGenerator.playTone(frequency: 600, duration: toneDuration)
        async let tone2: Void = toneGenerator.playTone(frequency: 600, duration: toneDuration)
        async let tone3: Void = toneGenerator.playTone(frequency: 600, duration: toneDuration)
    ...
    func testRapidAlternatingInputPattern() async {
        ...
        XCTAssertEqual(completedTones, expectedTones,
