        ...
        VStack(spacing: Theme.Spacing.lg) {
            ...
            VStack(spacing: Theme.Spacing.xl) {
                ...
                if viewModel.isWaitingForResponse {
                    TimeoutProgressBar(deadline: viewModel.responseDeadline, duration: viewModel.responseDuration)
                        .frame(height: 8)
    ...
    var body: some View {
        VStack(spacing: Theme.Spacing.lg) {
            ...
            VStack(spacing: Theme.Spacing.md) {
                ...
                if viewModel.isWaitingForResponse {
                    TimeoutProgressBar(deadline: viewModel.inputDeadline, duration: viewModel.inputDuration)
                        .frame(height: 8)
                        .padding(.horizontal, Theme.Spacing.xl)
                }
            }
