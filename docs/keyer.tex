...
\subsection{Integration with Koch CW Trainer}

This specification extends the Koch CW Trainer system (koch\_trainer.tex) by
...
The keyer integrates with the Koch CW Trainer's $TrainingSession$ through
these connections:
