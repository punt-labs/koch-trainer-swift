...
memory and timing. In \emph{ear} mode, the student hears a Morse pattern and
reproduces it by tapping dit/dah---training the ear-to-hand reflex without
